...
namespace Navegador_CPD
{
...

    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                File.Create(@"\\192.168.10.1\Public\Favoritos navegador cpd\Navegadorcpdfavoritos" + nomeMaquina + ".txt").Close();
            }
            else
            {
        ...
        private void btn_Fav_Click(object sender, EventArgs e)
        {
            ...
            File.WriteAllLines(@"\\192.168.10.1\Public\Favoritos navegador cpd\Navegadorcpdfavoritos" + nomeMaquina + ".txt", items);
        ...
        private void btn_RemovFav_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] Lines = File.ReadAllLines(@"\\192.168.10.1\Public\Favoritos navegador cpd\Navegadorcpdfavoritos" + nomeMaquina + ".txt");
                File.Delete(@"\\192.168.10.1\Public\Favoritos navegador cpd\Navegadorcpdfavoritos" + nomeMaquina + ".txt");// Deleting the file
                using (StreamWriter sw = File.AppendText(@"\\192.168.10.1\Public\Favoritos navegador cpd\Navegadorcpdfavoritos" + nomeMaquina + ".txt"))
